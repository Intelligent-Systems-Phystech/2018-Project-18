...
\begin{abstract}
Brain activity can be used as a control signal for brain-computer interface (BCI). This signal can be further interpreted, predicting behavioral patterns of the subject. In the following paper a system is investigated, using multiscale approach for input signal preprocessing, attribute selection and further pattern modeling. The model takes into account the continuity of trajectory of motion and presence of both descrete and continuous structural variables. <METHODS USED><RESULTS>
\end{abstract}
\begin{document}
...
%,oai:hal.inria.fr:hal-00762316,journals/neuroimage/KrishnanWMA11,oai:eprints.pascal-network.org:7846,bb86866
